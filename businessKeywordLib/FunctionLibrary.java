...
public class FunctionLibrary {
	...
	public static void navigatetoBooksPage() {
		try {
			...
			wait.until(ExpectedConditions.visibilityOf(HomePage.lnk_Amazon));
			//Perform hover action
			CommonFunctions.hover(HomePage.lnk_Departments, "Departments");
			//Wait for the element to be visible
			wait.until(ExpectedConditions.visibilityOf(HomePage.lnk_Books_Audible));
			//Perform hover action
			CommonFunctions.hover(HomePage.lnk_Books_Audible, "Books & Audible");
			//Wait for the element to be visible
